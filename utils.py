...
def get_theta(vector1, vector2):
    sub = vector2 - vector1
    if sub.x > 0:
        theta = math.atan(sub.y / sub.x)
    elif sub.x < 0:
        theta = math.atan(sub.y / sub.x) + math.pi
    elif sub.y > 0:
        theta = math.pi / 2
    else:
        theta = -math.pi / 2
...
def conflict(vector1, vector2, l):
    sub = vector2 - vector1
    return l >= math.sqrt(sub.x ** 2 + sub.y ** 2)


def district(vector1, vector2):
    sub = vector2 - vector1
